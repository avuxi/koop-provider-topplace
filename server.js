...
if (process.env.DEPLOY === 'export') {
  ...
  Try it out in your browser: http://localhost:${port}/vx/FeatureServer/0/query
  Or on the command line: curl --silent http://localhost:${port}/vx/FeatureServer/0/query?returnCountOnly=true
